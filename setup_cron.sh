...
(
echo "2 0 * * * cd /home/ubuntu/daily-asset && /home/ubuntu/daily-asset/venv/bin/python3 full_asset_status/run_full_btc.py >> /home/ubuntu/daily-asset/cron.log 2>&1"
...
echo "0 * * * * cd /home/ubuntu/daily-asset && /home/ubuntu/daily-asset/venv/bin/python3 ema_bb_signal/main.py >> /home/ubuntu/daily-asset/cron.log 2>&1"
) | crontab -
echo "Crontab set:"
crontab -l
